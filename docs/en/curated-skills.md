...
KZ SOP packages a small set of supplemental skills. They are included in the package, but `kz-sop init` does not copy long skill content into business projects by default.
